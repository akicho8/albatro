...
module Albatro
  module Responder
    class MarkovBaseResponder < Base
      def initialize(*)
        super
        dictionary
      end
...
if $0 == __FILE__
  str = "AとBとC"
  object = Albatro::Responder::MarkovResponder.new(:prefix => 2)
  ...
  # object = Albatro::Responder::MarkovResponder.new(options.merge(:sample_try_max => 0))
  # object.study_from(:string => str)
  ...
  str = "AとAとB"
  object = Albatro::Responder::MarkovBaseResponder.new(:prefix => 1)
  object.study_from(:string => str)
  pp object.dialogue2(:always_newtopic => true, :chain_max => 10).join

  object = Albatro::Responder::MarkovResponder.new(:prefix => 1)
  object.study_from(:string => str)
  pp object.dialogue2(:always_newtopic => true, :chain_max => 10).join
  ...
  object = Albatro::Responder::MarkovResponder.new
  ...
  # Albatro::Responder::MarkovResponder.new.interactive
  ...
  # object = Albatro::Responder::MarkovResponder.new
  object = Albatro::Responder::MarkovResponder.new(:prefix => prefix)
  strs.each{|str|
  ...
  object = Albatro::Responder::MarkovResponder.new(:database => "_test.db")
  object.clear
