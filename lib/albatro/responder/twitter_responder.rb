...
module Albatro
  module Responder
    ...
    #
    #   responder = Albatro::Responder::TwitterResponder.new
    #   p responder.dialogue("「初音ミク」の「痛車」") #=> "ロシアのNo.1のドライバーの車って初音ミクさんなのか"
    #
    class TwitterResponder < Base
...
if $0 == __FILE__
  Albatro::Responder::TwitterResponder.new(:mock => true).interactive(:messages => ["「初音ミク」の「痛車」", "焼肉ラーメンってあるの？"])
end
