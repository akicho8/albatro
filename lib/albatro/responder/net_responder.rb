...
if $0 == __FILE__
  ...
  Albatro::Responder::NetResponder.new(:mock => true).interactive(:messages => messages)
end

# [?] 初音ミクの画像ください
# [Responder::NetResponder] http://a0.twimg.com/profile_images/1278882154/popopopon_normal.jpg
# [?] 伊坂幸太郎の本が欲しい
# [Responder::NetResponder] ゴールデンスランバー (新潮文庫)のこと？
# [?] 自炊の本が欲しい
# [Responder::NetResponder] つくりおきおかずで朝つめるだけ!弁当 決定版 (別冊エッセ)のこと？
# [?] 卓球台が欲しい
# [Responder::NetResponder] 卓球台—冨田正吉句集 (朝俳句叢書)のこと？
# [?] 石原慎太郎とは誰ですか
# [Responder::NetResponder] 石原 慎太郎（いしはら しんたろう、旧字体:石原 愼太郎、1932年（昭和7年）9月30日 - ）は、日本の政治家、作家。東京都知事（第14・15・16・17代）だそうです
# [?] 初音ミクとは何ですか
# [Responder::NetResponder] 初音 ミク（はつね ミク、HATSUNE MIKU）は、クリプトン・フューチャー・メディアから 発売されている音声合成・デスクトップミュージック（DTM）ソフトウェアの製品だそうです
